...
public class PersonTests
{
    ...
    public void Test_GetByAgeAscending_SortsPeopleByAge()
    {
        ...
        string expected = $"Marry with ID: 2 is 25 years old.{Environment.NewLine}" +
            $"John with ID: 1 is 30 years old.{Environment.NewLine}Ivan with ID: 3 is 50 years old.";
    ...
    [Test]
    public void Test_GetByAgeDescending_ReturnsEmptyString_WhenGivenNoData()
    {
        // Arrange 
